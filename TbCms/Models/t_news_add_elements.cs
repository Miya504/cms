...
namespace TbCms.Models
{
    ...
    public partial class t_news_add_elements
    {
        public int news_id { get; set; }
        public short news_add_order { get; set; }
        public byte news_element_id { get; set; }
        public string word_element_1 { get; set; }
        public string word_element_2 { get; set; }
        public Nullable<long> number_element_1 { get; set; }
        public Nullable<long> number_element_2 { get; set; }
        public string control_element_1 { get; set; }
        public string control_element_2 { get; set; }
