...
namespace TbCms.Models
{
    ...
    public partial class m_paper_sizes
    {
        public short paper_size_id { get; set; }
        public string paper_size_name { get; set; }
        public string paper_picture_path { get; set; }
        public Nullable<byte> Imposition_height { get; set; }
        public Nullable<byte> Imposition_width { get; set; }
        public string print_angle { get; set; }
